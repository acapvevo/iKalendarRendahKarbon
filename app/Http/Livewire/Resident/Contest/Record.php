...
class Record extends Component
{
    ...
    public function update()
    {
        ...
        redirect(route('resident.contest.submission.view', ['submission_id' => $this->submission_id, 'category' => $this->category_code]))->with('success', __('alerts.record_update', ['month' => $this->month->getName(), 'category' => __($this->category_description)]));
    }

    public function render()
    {
        $this->submission = $this->getSubmissionProperty();
        return view('livewire.resident.contest.record');
    }
}
