...
<div>
        ...
        <table class="table table-bordered text-center" id="evidenceTable" style="width:100%">
            ...
            <tbody>
                @foreach ($evidences as $evidenceObj)
                    <tr>
                        <td>{{ $evidenceObj->title }} {!! $evidenceObj->checkFile()
                            ? ''
                            : ' <span class="text-danger"><i class="fa-solid fa-circle-exclamation fa-beat"></i> ' .
                                __("Please update this evidence's file") .
                                '</span>' !!}</td>
                        <td>
                            <div class="justify-content-center">
                                <div class="btn-group-vertical d-lg-none" role="group"
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm"
                                        wire:click.prevent='open({{ $evidenceObj->id }})' data-bs-toggle="modal"
                                        data-bs-target="#updateEvidenceModal">
                                        <i data-bs-toggle="tooltip" data-bs-title="{{ __('Update Evidence') }}"
    ...
    <div wire:ignore.self class="modal fade" id="updateEvidenceModal" tabindex="-1"
        aria-labelledby="updateEvidenceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="updateEvidenceModalLabel">{{ __('Update Evidence') }}</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="{{ __('Close') }}"></button>
                </div>
                <div class="modal-body">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        closeModal('updateEvidenceModal');
    </script>
@endpush
