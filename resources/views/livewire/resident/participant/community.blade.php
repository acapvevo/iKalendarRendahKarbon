    ...
    <script>
        ...
        $('#addCommunity').select2({
            ...
            ajax: {
                ...
                url: '{{ route('resident.participant.community.select') }}',
                dataType: 'json',
                delay: 250,
                cache: true,
            ...
            allowClear: true,
            dropdownParent: $('#addCommunityModal'),
        ...
        function formatCommunityResult(community) {
            ...
            var image = "{{ asset('assets/img/illustrations/profiles/profile-1.png') }}";
        ...
        $('#addCommunity').on('change', function(e) {
