...
<div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="viewRecordModalLabel">{{ __('View Submission for') }}
    ...
    <div class="modal fade" id="editRecordModal" tabindex="-1" aria-labelledby="editRecordModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editRecordModalLabel">{{ __('Edit Submission for') }}
                        {{ $month ? $month->getName() : '' }}</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
@push('scripts')
    <script>
        ...
        editRecordModalEl.addEventListener('hidden.bs.modal', event => {
            @this.emit('closeModal')
        })
        const viewRecordModalEl = document.getElementById('viewRecordModal')
        viewRecordModalEl.addEventListener('hidden.bs.modal', event => {
            @this.emit('closeModal')
        })
