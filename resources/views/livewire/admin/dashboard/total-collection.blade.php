                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="h5">{{ number_format($calculation->total_usage_each_type[$category->name], 2) }} {!! $category->symbol !!}</div>
                                </div>
                                <div class="ms-2">
                                    <iconify-icon class="fa-4x text-gray-200" icon="{{ $category->icon }}"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
