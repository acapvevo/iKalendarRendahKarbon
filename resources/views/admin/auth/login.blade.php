...
@section('title', __('Login As Admin'))
    ...
    <div class="col-lg-5">
        ...
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            <div class="card-header justify-content-center">
                <h3 class="fw-light my-4 text-center">{{ __('Login As Admin') }}</h3>
            </div>
            <div class="card-body">
                <!-- Login form-->
                <form class="auth-form login-form" action="{{ route('admin.login') }}" method="post">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        <a class="small" href="{{ route('admin.password.request') }}">{{ __('Forgot Password?') }}</a>
