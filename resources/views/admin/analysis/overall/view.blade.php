        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-xl-auto mt-4">{{ __('Overall Analysis') }}</div>
                </div>
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        <li class="breadcrumb-item"><a href="#">{{ __('Analysis Management') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('Overall Analysis') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
...
@section('content')
    <div class="container-xl px-4 mt-n10">
        <div class="card">
            <div class="card-header text-center">{{ __('Overall Analysis for') }} <br> {{ $currentCompetition->year }}
            </div>
            <div class="card-body">
                    ...
                    <form action="{{ route('admin.analysis.competition.view') }}" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="btn btn-primary"
                                formaction="{{ route('admin.analysis.overall.export') }}"
                ...
                <div class="tab-content py-3" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-overall" role="tabpanel"
                        ...
                        @livewire('admin.analysis.overall.overall', ['competition' => $currentCompetition])
                    </div>
