        ...
        <div class="row gx-4">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body"><input class="form-control" id="postTitleInput" type="text"
                            placeholder="Enter your post title..."
                            value="Boots on the Ground, Inclusive Thought Provoking Ideas" /></div>
                </div>
                <div class="card card-header-actions mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="lh-base form-control" type="text" placeholder="Enter your post preview text..." rows="4">Empower communities and energize engaging ideas; scale and impact do-gooders while disrupting industries. Venture philanthropy benefits corporations and people by moving the needle.</textarea>
                    </div>
                </div>
