            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body py-5">
                        ...
                        <p class="card-text">Information about what you can and can't do when using our logos and other
                            assets</p>
                    </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body py-5">
                        ...
                        <p class="card-text">Troubleshoot billing issues, subscriptions, and updating payment information
                        </p>
                    </div>
                    <div class="card-footer">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body py-5">
                        ...
                        <p class="card-text">Other troubleshooting, help, and support articles related to our products and
                            services</p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">2 articles in this category</div>
