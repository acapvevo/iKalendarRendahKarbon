            ...
            <div class="row g-0">
                ...
                <div class="col">
                    <div class="card-body py-4">
                        ...
                        <p class="card-text mb-1">Basic information about getting started including installation
                            instructions, setup, and basic usage.</p>
            ...
            <div class="row g-0">
                ...
                <div class="col">
                    <div class="card-body py-4">
                        ...
                        <p class="card-text mb-1">Troubleshooting guides specific to your account including creating new
                            accounts, modifying existing accounts, and deleting accounts.</p>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Information about what you can and can't do when using our logos and other
                            assets</p>
                    </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Troubleshoot billing issues, subscriptions, and updating payment
                            information</p>
                    </div>
                    <div class="card-footer">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">App integration policies and related content on connecting to our database
                        </p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">5 articles in this category</div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Our privacy policy and information on how we track and utilize user data
                        </p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">2 articles in this category</div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="knowledge-base-category.html">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Other troubleshooting, help, and support articles related to our products
                            and services</p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">2 articles in this category</div>
