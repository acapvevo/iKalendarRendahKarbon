...
@section('title')
    <h1 class="app-page-title">Help</h1>
@endsection
        ...
        <div class="col-12 col-md-6">
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                ...
                <div class="app-card-body px-4">
                    ...
                    <div class="intro mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam aliquet eros vel
        ...
        <div class="col-12 col-md-6">
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                ...
                <div class="app-card-body px-4">
                    ...
                    <div class="intro mb-3">Quisque non nisi odio. Proin at viverra enim. Ut vitae ligula neque. Praesent
                        id ligula ut sem suscipit eleifend id vel ex.</div>
                    <ul class="list-unstyled">
                        <li>
