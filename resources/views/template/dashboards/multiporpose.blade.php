                    ...
                    <div class="card-body py-5">
                        <div class="d-flex flex-column justify-content-center">
                            ...
                            <div class="text-center px-0 px-lg-5">
                                ...
                                <p class="mb-4">Our new report generation system is now online. You can start creating
                                    custom reporting for any documents available on your account.</p>
            ...
            <div class="col-xxl-4">
                ...
                <div class="card">
                    <div class="card-body text-center p-5">
                        <img class="img-fluid mb-4" src="{{ asset('assets/img/illustrations/team-spirit.svg') }}"
