            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Dialog boxes to display lightbox, notifications, or other custom
                            content</div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="sbp-preview mb-4">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">This modal window is included with the Bootstrap
                                                    framework. The styling has been changed for the SB Admin Pro theme.
                                                </div>
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalDefaultTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalDefaultHtmlTab" data-bs-toggle="tab"
                                                href="#modalDefaultHtml" role="tab" aria-controls="modalDefaultHtml"
                                                aria-selected="true">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalDefaultPugTab" data-bs-toggle="tab"
                                                href="#modalDefaultPug" role="tab" aria-controls="modalDefaultPug"
                                                aria-selected="false">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalDefaultHtml" role="tabpanel"
                                            aria-labelledby="modalDefaultHtmlTab">
...
<div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Save changes</button></div>
                                        ...
                                        <div class="tab-pane" id="modalDefaultPug" role="tabpanel"
                                            aria-labelledby="modalDefaultPugTab">
...
button.btn.btn-primary(type='button') Save changes</code></pre>
                                ...
                                <div class="sbp-preview-text">The default Bootstrap modal has been restyled for the SB Admin
                                    Pro theme.</div>
                            </div>
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    ...
                                    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Static Backdrop Modal
                                                    </h5>
                                                    <button class="btn-close" type="button" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    attribute with a modal window, the user cannot dismiss the modal by
                                                    clicking outside of the modal pane.
                                                </div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-bs-dismiss="modal">Close</button>
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalDefaultStaticTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalDefaultStaticHtmlTab"
                                                data-bs-toggle="tab" href="#modalDefaultStaticHtml" role="tab"
                                                aria-controls="modalDefaultStaticHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalDefaultStaticPugTab" data-bs-toggle="tab"
                                                href="#modalDefaultStaticPug" role="tab"
                                                aria-controls="modalDefaultStaticPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalDefaultStaticHtml" role="tabpanel"
                                            aria-labelledby="modalDefaultStaticHtmlTab">
                                            <pre class="language-markup"><code><script type="text/plain"><!-- Button trigger modal -->
...
<div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Understood</button></div>
                                        ...
                                        <div class="tab-pane" id="modalDefaultStaticPug" role="tabpanel"
                                            aria-labelledby="modalDefaultStaticPugTab">
                                            <pre class="language-pug"><code>//- Button trigger modal
...
button.btn.btn-primary(type='button') Understood</code></pre>
                                ...
                                <div class="sbp-preview-text">The static backdrop modal option cannot be dismissed by
                                    clicking outside of the modal pane. Instead, the user must dismiss the modal by using
                                    the close button within the modal pane.</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview mb-4">
                                <div class="sbp-preview-content">
                                    <!-- Button trigger modal-->
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalLong">Launch Scrollable Modal</button>
                                    <!-- Modal-->
                                    <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Long Modal with
                                                        Page Scrolling</h5>
                                                    <button class="btn-close" type="button" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalScrollingTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalScrollingHtmlTab"
                                                data-bs-toggle="tab" href="#modalScrollingHtml" role="tab"
                                                aria-controls="modalScrollingHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalScrollingPugTab" data-bs-toggle="tab"
                                                href="#modalScrollingPug" role="tab"
                                                aria-controls="modalScrollingPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalScrollingHtml" role="tabpanel"
                                            aria-labelledby="modalScrollingHtmlTab">
                                            <pre class="language-markup"><code><script type="text/plain"><!-- Button trigger modal -->
...
<div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Save changes</button></div>
                                        ...
                                        <div class="tab-pane" id="modalScrollingPug" role="tabpanel"
                                            aria-labelledby="modalScrollingPugTab">
                                            <pre class="language-pug"><code>//- Button trigger modal
...
button.btn.btn-primary(type='button') Save changes</code></pre>
                                ...
                                <div class="sbp-preview-text">By default, the content within a modal will scroll
                                    independently of the page if the content is too long. If you don't want the page to
                                    scroll, use the next option.</div>
                            </div>
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <!-- Button trigger modal-->
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalScrollable">Launch Scrollable Modal</button>
                                    <!-- Modal-->
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalScrollingDialogTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalScrollingDialogHtmlTab"
                                                data-bs-toggle="tab" href="#modalScrollingDialogHtml" role="tab"
                                                aria-controls="modalScrollingDialogHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalScrollingDialogPugTab" data-bs-toggle="tab"
                                                href="#modalScrollingDialogPug" role="tab"
                                                aria-controls="modalScrollingDialogPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalScrollingDialogHtml" role="tabpanel"
                                            aria-labelledby="modalScrollingDialogHtmlTab">
...
<div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Save changes</button></div>
                                        ...
                                        <div class="tab-pane" id="modalScrollingDialogPug" role="tabpanel"
                                            aria-labelledby="modalScrollingDialogPugTab">
                                            <pre class="language-pug"><code>//- Button trigger modal
...
button.btn.btn-primary(type='button') Save changes</code></pre>
                                ...
                                <div class="sbp-preview-text">
                                    ...
                                    to make longer modal content scroll within the modal body if the contents is longer than
                                    the viewport height.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sbp-preview">
                                    ...
                                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">The vertically centered modal centers the modal
                                                    dialog in the center of the page.</div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button class="btn btn-primary" type="button">Save changes</button>
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalCenteredTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalCenteredHtmlTab"
                                                data-bs-toggle="tab" href="#modalCenteredHtml" role="tab"
                                                aria-controls="modalCenteredHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalCenteredPugTab" data-bs-toggle="tab"
                                                href="#modalCenteredPug" role="tab" aria-controls="modalCenteredPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalCenteredHtml" role="tabpanel"
                                            aria-labelledby="modalCenteredHtmlTab">
                                            <pre class="language-markup"><code><script type="text/plain"><!-- Button trigger modal -->
...
<div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-primary" type="button">Save changes</button></div>
                                        ...
                                        <div class="tab-pane" id="modalCenteredPug" role="tabpanel"
                                            aria-labelledby="modalCenteredPugTab">
                                            <pre class="language-pug"><code>//- Button trigger modal
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <!-- Extra large modal-->
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalXl">Extra Large</button>
                                    ...
                                    <!-- Large modal-->
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalLg">Large</button>
                                    ...
                                    <!-- Small modal-->
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalSm">Small</button>
                                    <div class="modal fade" id="exampleModalSm" tabindex="-1" role="dialog"
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="modalSizingTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="modalSizingHtmlTab" data-bs-toggle="tab"
                                                href="#modalSizingHtml" role="tab" aria-controls="modalSizingHtml"
                                                aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="modalSizingPugTab" data-bs-toggle="tab"
                                                href="#modalSizingPug" role="tab" aria-controls="modalSizingPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="modalSizingHtml" role="tabpanel"
                                            aria-labelledby="modalSizingHtmlTab">
...
<div class="modal-footer"><button class="btn btn-primary" type="button" data-bs-dismiss="modal">Close</button></div>
                                        ...
                                        <div class="tab-pane" id="modalSizingPug" role="tabpanel"
                                            aria-labelledby="modalSizingPugTab">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col">
                            <div class="card-body py-5">
                                ...
                                <p class="card-text">Modals are a default component included with the Bootstrap framework.
                                    For more information on implementing, modifying, and extending the usage of modals
                                    within your project, visit the official Bootstrap modal documentation page.</p>
                                <a class="btn btn-secondary btn-sm"
                                    href="https://getbootstrap.com/docs/4.4/components/modal/" target="_blank">
