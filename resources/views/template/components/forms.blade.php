...
textarea#exampleFormControlTextarea1.form-control(rows='3')
                                ...
                                <div class="sbp-preview-text">The default Bootstrap form control states have been restyled
                                    to fit the SB Admin Pro theme. The style has changed, but the markup is identical.</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleFormControlSelect2">Example multiple select</label>
                                            <select class="form-control form-control-solid" id="exampleFormControlSelect2"
                                                multiple="">
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="formsSolidTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="formsSolidHtmlTab" data-bs-toggle="tab"
                                                href="#formsSolidHtml" role="tab" aria-controls="formsSolidHtml"
                                                aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="formsSolidPugTab" data-bs-toggle="tab"
                                                href="#formsSolidPug" role="tab" aria-controls="formsSolidPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
...
textarea#exampleFormControlTextarea1.form-control.form-control-solid(rows='3')
                                ...
                                <div class="sbp-preview-text">
                                    Custom solid form controls have been developed as an alternative to the default form
                                    styling. Use them by appending the
                            ...
                            <div class="sbp-preview mb-4">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="formsCheckboxesTabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="formsCheckboxesPugTab" data-bs-toggle="tab"
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="formsCheckboxesHtml" role="tabpanel"
...
| Disabled checkbox</code></pre>
                                ...
                                <div class="sbp-preview-text">Bootstrap's custom checkbox styling has been modified for the
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexRadioDefault3">Default disabled
                                            radio</label>
                                    </div>
                                </div>
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="formsRadioTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="formsRadioHtmlTab" data-bs-toggle="tab"
                                                href="#formsRadioHtml" role="tab" aria-controls="formsRadioHtml"
                                                aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="formsRadioPugTab" data-bs-toggle="tab"
                                                href="#formsRadioPug" role="tab" aria-controls="formsRadioPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
...
| Default disabled radio</code></pre>
                                ...
                                <div class="sbp-preview-text">Bootstrap's custom radio styling has also been modified for
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview mb-4">
                                <div class="sbp-preview-content">
                                    ...
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="flexCheckSolidChecked" type="checkbox"
                                            value="" checked />
                                        <label class="form-check-label" for="flexCheckSolidChecked">Checked
                                            checkbox</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="flexCheckSolidDisabled" type="checkbox"
                                            value="" disabled />
                                        <label class="form-check-label" for="flexCheckSolidDisabled">Disabled
                                            checkbox</label>
                                    </div>
                                </div>
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="formsCheckboxesSolidTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="formsCheckboxesSolidHtmlTab"
                                                data-bs-toggle="tab" href="#formsCheckboxesSolidHtml" role="tab"
                                                aria-controls="formsCheckboxesSolidHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="formsCheckboxesSolidPugTab" data-bs-toggle="tab"
                                                href="#formsCheckboxesSolidPug" role="tab"
                                                aria-controls="formsCheckboxesSolidPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{asset("assets/img/demo/pug.svg")}}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="formsCheckboxesSolidHtml" role="tabpanel"
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    ...
                                    <div class="form-check form-check-solid">
                                        ...
                                        <label class="form-check-label" for="flexRadioSolid2">Default checked
                                            radio</label>
                                    </div>
                                    <div class="form-check form-check-solid">
                                        <input class="form-check-input" id="flexRadioSolid3" type="radio"
                                            name="flexRadioSolid" disabled />
                                        <label class="form-check-label" for="flexRadioSolid3">Default disabled
                                            radio</label>
                                    </div>
                                </div>
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="formsRadioSolidTabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="formsRadioSolidPugTab" data-bs-toggle="tab"
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="formsRadioSolidHtml" role="tabpanel"
                            ...
                            <div class="sbp-preview">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="inputGroupJoinedTabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="inputGroupJoinedPugTab" data-bs-toggle="tab"
                                                href="#inputGroupJoinedPug" role="tab"
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="inputGroupJoinedHtml" role="tabpanel"
                                            aria-labelledby="inputGroupJoinedHtmlTab">
...
input.form-control.ps-0(type='text', placeholder='Input group prepend...', aria-label='Search')</code></pre>
                                ...
                                <div class="sbp-preview-text">
                                    ...
                                    CSS pseudo class to join input group appends and prepends within an input group. Unlike
                                    Bootstrap's default input group behavior, these joined input group variations will focus
                                    the entire input group when the form control within is selected. This variation also
                                    removes the background and border coloring of the append and prepend elements for a
                            ...
                            <div class="sbp-preview">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="dateRangePickerTabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="dateRangePickerPugTab" data-bs-toggle="tab"
                                                href="#dateRangePickerPug" role="tab"
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="dateRangePickerHtml" role="tabpanel"
                                            aria-labelledby="dateRangePickerHtmlTab">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col">
                            <div class="card-body py-5">
                                ...
                                <p class="card-text">Forms are a default component included with the Bootstrap framework.
                                    For more information on implementing, modifying, and extending the usage of forms within
                                    your project, visit the official Bootstrap forms documentation page.</p>
                                <a class="btn btn-secondary btn-sm"
                                    href="https://getbootstrap.com/docs/4.4/components/forms/" target="_blank">
                        ...
                        <div class="card-body">
                            <ul class="nav flex-column" id="stickyNav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#checkbox">Default Checkboxes &amp;
                                        Radio</a></li>
                                <li class="nav-item"><a class="nav-link" href="#checkboxSolid">Solid Checkboxes &amp;
                                        Radio</a></li>
                                <li class="nav-item">
