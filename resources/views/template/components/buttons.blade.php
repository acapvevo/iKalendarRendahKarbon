            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">Restyled Bootstrap default buttons and custom developed button
                            components</div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="sbp-preview mb-4">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsDefaultTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsDefaultHtmlTab" data-bs-toggle="tab"
                                                href="#buttonsDefaultHtml" role="tab" aria-controls="buttonsDefaultHtml"
                                                aria-selected="true">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsDefaultPugTab" data-bs-toggle="tab"
                                                href="#buttonsDefaultPug" role="tab" aria-controls="buttonsDefaultPug"
                                                aria-selected="false">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsDefaultHtml" role="tabpanel"
                                            aria-labelledby="buttonsDefaultHtmlTab">
                                            <pre class="language-markup"><code><script type="text/plain"><button class="btn btn-primary" type="button">Primary</button>
...
<button class="btn btn-link" type="button">Link</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsDefaultPug" role="tabpanel"
                                            aria-labelledby="buttonsDefaultPugTab">
...
button.btn.btn-link(type='button') Link</code></pre>
                                ...
                                <div class="sbp-preview-text">Bootstrap's default state-specific button styles have been
                                    styled to fit the SB Admin Pro theme.</div>
                            </div>
                            ...
                            <div class="sbp-preview">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsDefaultOutlineTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsDefaultOutlineHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsDefaultOutlineHtml" role="tab"
                                                aria-controls="buttonsDefaultOutlineHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsDefaultOutlinePugTab" data-bs-toggle="tab"
                                                href="#buttonsDefaultOutlinePug" role="tab"
                                                aria-controls="buttonsDefaultOutlinePug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsDefaultOutlineHtml" role="tabpanel"
                                            aria-labelledby="buttonsDefaultOutlineHtmlTab">
...
<button class="btn btn-outline-link" type="button">Link</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsDefaultOutlinePug" role="tabpanel"
                                            aria-labelledby="buttonsDefaultOutlinePugTab">
...
button.btn.btn-outline-link(type='button') Link</code></pre>
                                ...
                                <div class="sbp-preview-text">Outline button styles are also available by default from
                                    Bootstrap.</div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="sbp-preview mb-4">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsCustomTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsCustomHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsCustomHtml" role="tab"
                                                aria-controls="buttonsCustomHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsCustomPugTab" data-bs-toggle="tab"
                                                href="#buttonsCustomPug" role="tab" aria-controls="buttonsCustomPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsCustomHtml" role="tabpanel"
                                            aria-labelledby="buttonsCustomHtmlTab">
...
<button class="btn btn-pink" type="button">Pink</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsCustomPug" role="tabpanel"
                                            aria-labelledby="buttonsCustomPugTab">
...
button.btn.btn-pink(type='button') Pink</code></pre>
                                ...
                                <div class="sbp-preview-text">By default, Bootstrap's buttons are semantically named. We've
                                    extended the Bootstrap framework to include non-contextual colors.</div>
                            </div>
                            <!-- Custom Button Outline Colors Component Preview-->
                            <h6 class="small text-muted fw-500" id="customColorsOutline">Non-Contextual Outline Button
                                Colors:</h6>
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsCustomOutlineTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsCustomOutlineHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsCustomOutlineHtml" role="tab"
                                                aria-controls="buttonsCustomOutlineHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsCustomOutlinePugTab" data-bs-toggle="tab"
                                                href="#buttonsCustomOutlinePug" role="tab"
                                                aria-controls="buttonsCustomOutlinePug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsCustomOutlineHtml" role="tabpanel"
                                            aria-labelledby="buttonsCustomOutlineHtmlTab">
...
<button class="btn btn-outline-pink" type="button">Pink</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsCustomOutlinePug" role="tabpanel"
                                            aria-labelledby="buttonsCustomOutlinePugTab">
...
button.btn.btn-outline-pink(type='button') Pink</code></pre>
                                ...
                                <div class="sbp-preview-text">SB Admin Pro's non-contextual color classes work with outline
                                    buttons as well!</div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="icon">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="sbp-preview mb-4">
                                <div class="sbp-preview-content">
                                    <button class="btn btn-red btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-orange btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-yellow btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-green btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-teal btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-cyan btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-blue btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-indigo btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-purple btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-pink btn-icon my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                </div>
                                <div class="sbp-preview-code">
                                    <!-- Code sample-->
                                    <ul class="nav nav-tabs" id="buttonsIconFeatherTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsIconFeatherHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsIconFeatherHtml" role="tab"
                                                aria-controls="buttonsIconFeatherHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsIconFeatherPugTab" data-bs-toggle="tab"
                                                href="#buttonsIconFeatherPug" role="tab"
                                                aria-controls="buttonsIconFeatherPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsIconFeatherHtml" role="tabpanel"
                                            aria-labelledby="buttonsIconFeatherHtmlTab">
...
<i data-feather="feather"></i>
                                        ...
                                        <div class="tab-pane" id="buttonsIconFeatherPug" role="tabpanel"
                                            aria-labelledby="buttonsIconFeatherPugTab">
...
i(data-feather='feather')</code></pre>
                                ...
                                <div class="sbp-preview-text">Our custom icon button component is circular by default, and
                                    looks great when used with Feather Icons, which are included with this theme.</div>
                            </div>
                            <!-- Icon Buttons (Font Awesome Icons) Component Preview-->
                            <h6 class="small text-muted fw-500" id="iconFontAwesome">Icon Buttons (Font Awesome Icons):
                            </h6>
                            <div class="sbp-preview mb-4">
                                <div class="sbp-preview-content">
                                    <button class="btn btn-red btn-icon me-2 my-1" type="button"><i
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsIconFontAwesomeTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsIconFontAwesomeHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsIconFontAwesomeHtml" role="tab"
                                                aria-controls="buttonsIconFontAwesomeHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsIconFontAwesomePugTab" data-bs-toggle="tab"
                                                href="#buttonsIconFontAwesomePug" role="tab"
                                                aria-controls="buttonsIconFontAwesomePug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsIconFontAwesomeHtml" role="tabpanel"
                                            aria-labelledby="buttonsIconFontAwesomeHtmlTab">
                                            <pre class="language-markup"><code><script type="text/plain"><button class="btn btn-red btn-icon" type="button">
...
<i class="fas fa-flag"></i>
                                        ...
                                        <div class="tab-pane" id="buttonsIconFontAwesomePug" role="tabpanel"
                                            aria-labelledby="buttonsIconFontAwesomePugTab">
                                            <pre class="language-pug"><code>button.btn.btn-red.btn-icon(type='button')
i.fas.fa-flag
button.btn.btn-orange.btn-icon(type='button')
i.fas.fa-flag
                            ...
                            <div class="sbp-preview mb-4">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsIconTextTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsIconTextHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsIconTextHtml" role="tab"
                                                aria-controls="buttonsIconTextHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsIconTextPugTab" data-bs-toggle="tab"
                                                href="#buttonsIconTextPug" role="tab"
                                                aria-controls="buttonsIconTextPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsIconTextHtml" role="tabpanel"
                                            aria-labelledby="buttonsIconTextHtmlTab">
...
<button class="btn btn-pink btn-icon" type="button">O</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsIconTextPug" role="tabpanel"
                                            aria-labelledby="buttonsIconTextPugTab">
...
button.btn.btn-pink.btn-icon(type='button') O</code></pre>
                                ...
                                <div class="sbp-preview-text">Icon buttons use a fixed height and width, so you can use
                                    them with short strings of text, one or two characters long.</div>
                            </div>
                            <!-- Icon Buttons (Outline) Component Preview-->
                            <h6 class="small text-muted fw-500" id="iconOutline">Icon Buttons (Outline):</h6>
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <button class="btn btn-outline-red btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-orange btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-yellow btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-green btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-teal btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-cyan btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-blue btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-indigo btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-purple btn-icon me-2 my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                    <button class="btn btn-outline-pink btn-icon my-1" type="button"><i
                                            data-feather="feather"></i></button>
                                </div>
                                <div class="sbp-preview-code">
                                    <!-- Code sample-->
                                    <ul class="nav nav-tabs" id="buttonsIconOutlineTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsIconOutlineHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsIconOutlineHtml" role="tab"
                                                aria-controls="buttonsIconOutlineHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsIconOutlinePugTab" data-bs-toggle="tab"
                                                href="#buttonsIconOutlinePug" role="tab"
                                                aria-controls="buttonsIconOutlinePug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsIconOutlineHtml" role="tabpanel"
                                            aria-labelledby="buttonsIconOutlineHtmlTab">
...
<i data-feather="feather"></i>
                                        ...
                                        <div class="tab-pane" id="buttonsIconOutlinePug" role="tabpanel"
                                            aria-labelledby="buttonsIconOutlinePugTab">
                            ...
                            <div class="sbp-preview">
                                <div class="sbp-preview-content p-0">
                                    <div class="bg-dark p-4 border-bottom">
                                        ...
                                        <button class="btn btn-transparent-light btn-icon" type="button"><i
                                                data-feather="feather"></i></button>
                                    </div>
                                    <div class="p-4 border-bottom">
                                        <button class="btn btn-transparent-dark me-2" type="button">Hover Me!</button>
                                        <button class="btn btn-transparent-dark btn-icon" type="button"><i
                                                data-feather="feather"></i></button>
                                    </div>
                                    <div class="bg-dark p-4 border-bottom">
                                        <button class="btn btn-white-10 me-2" type="button">Hover Me!</button>
                                        <button class="btn btn-white-10 btn-icon" type="button"><i
                                                data-feather="feather"></i></button>
                                    </div>
                                </div>
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsTransparentTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsTransparentHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsTransparentHtml" role="tab"
                                                aria-controls="buttonsTransparentHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsTransparentPugTab" data-bs-toggle="tab"
                                                href="#buttonsTransparentPug" role="tab"
                                                aria-controls="buttonsTransparentPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsTransparentHtml" role="tabpanel"
                                            aria-labelledby="buttonsTransparentHtmlTab">
...
<button class="btn btn-white-10" type="button">...</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonsTransparentPug" role="tabpanel"
                                            aria-labelledby="buttonsTransparentPugTab">
...
button.btn.btn-white-10(type='button') ...</code></pre>
                                ...
                                <div class="sbp-preview-text">Our transparent button component is available to use in place
                                    of a button color. This color styling works with all of the other customization options
                                    available, including icon buttons.</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sbp-preview mb-4">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonSizingTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonSizingHtmlTab" data-bs-toggle="tab"
                                                href="#buttonSizingHtml" role="tab" aria-controls="buttonSizingHtml"
                                                aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonSizingPugTab" data-bs-toggle="tab"
                                                href="#buttonSizingPug" role="tab" aria-controls="buttonSizingPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonSizingHtml" role="tabpanel"
                                            aria-labelledby="buttonSizingHtmlTab">
...
<button class="btn btn-primary btn-xl">Extra Large</button></script></code></pre>
                                        ...
                                        <div class="tab-pane" id="buttonSizingPug" role="tabpanel"
                                            aria-labelledby="buttonSizingPugTab">
...
button.btn.btn-primary.btn-xl Extra Large</code></pre>
                                ...
                                <div class="sbp-preview-text">Button sizes have been extended from Bootstrap defaults to
                                    include extra small and extra large buttons.</div>
                            </div>
                            <!-- Component Preview-->
                            <h6 class="small text-muted fw-500">Sizing Options (Icon Buttons):</h6>
                            <div class="sbp-preview">
                                <div class="sbp-preview-content">
                                    <button class="btn btn-primary btn-xs btn-icon me-2 my-1"><i
                                            class="fas fa-flag"></i></button>
                                    <button class="btn btn-primary btn-sm btn-icon me-2 my-1"><i
                                            class="fas fa-flag"></i></button>
                                    <button class="btn btn-primary btn-icon me-2 my-1"><i
                                            class="fas fa-flag"></i></button>
                                    <button class="btn btn-primary btn-lg btn-icon me-2 my-1"><i
                                            class="fas fa-flag"></i></button>
                                    <button class="btn btn-primary btn-xl btn-icon my-1"><i
                                            class="fas fa-flag"></i></button>
                                </div>
                                <div class="sbp-preview-code">
                                    <!-- Code sample-->
                                    <ul class="nav nav-tabs" id="buttonSizingIconsTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonSizingIconsHtmlTab"
                                                data-bs-toggle="tab" href="#buttonSizingIconsHtml" role="tab"
                                                aria-controls="buttonSizingIconsHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonSizingIconsPugTab" data-bs-toggle="tab"
                                                href="#buttonSizingIconsPug" role="tab"
                                                aria-controls="buttonSizingIconsPug" aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                        </li>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonSizingIconsHtml" role="tabpanel"
                                            aria-labelledby="buttonSizingIconsHtmlTab">
...
<i class="fas fa-flag"></i>
                                        ...
                                        <div class="tab-pane" id="buttonSizingIconsPug" role="tabpanel"
                                            aria-labelledby="buttonSizingIconsPugTab">
...
i.fas.fa-flag</code></pre>
                                ...
                                <div class="sbp-preview-text">The custom icon button component is compatible with all of
                                    the button sizing options available.</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="sbp-preview">
                                ...
                                <div class="sbp-preview-code">
                                    ...
                                    <ul class="nav nav-tabs" id="buttonsSocialTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active me-1" id="buttonsSocialHtmlTab"
                                                data-bs-toggle="tab" href="#buttonsSocialHtml" role="tab"
                                                aria-controls="buttonsSocialHtml" aria-selected="true">
                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                HTML
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="buttonsSocialPugTab" data-bs-toggle="tab"
                                                href="#buttonsSocialPug" role="tab" aria-controls="buttonsSocialPug"
                                                aria-selected="false">
                                                <img class="img-pug me-1" src="{{ asset('assets/img/demo/pug.svg') }}" />
                                                PUG
                                            </a>
                                    ...
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="buttonsSocialHtml" role="tabpanel"
                                            aria-labelledby="buttonsSocialHtmlTab">
...
<i class="fab fa-twitter"></i> Twitter
                                        ...
                                        <div class="tab-pane" id="buttonsSocialPug" role="tabpanel"
                                            aria-labelledby="buttonsSocialPugTab">
...
| Twitter</code></pre>
                                ...
                                <div class="sbp-preview-text">A select group of popular brands have had custom buttons
                                    styles added. The example above uses the Font Awesome brand icons in unison with the
                                    custom brand button styling.</div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text small">Utility classes are a quick and powerful way to
                                                extend the styling the button component. Specifically, border, shadow, text,
                                                and spacing utilities work well to customize a button.</p>
                                            <p class="card-text small">Use utility classes to transform the style of a
                                                single button, or a small group of buttons. The best way to globally restyle
                                                the button component is by overriding button specific SCSS variables.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sbp-btn-example mb-4">
                                ...
                                <div class="border border-lg rounded">
                                    <div class="p-4 border-bottom">
                                        ...
                                        <button class="btn btn-primary btn-icon rounded-0 me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-secondary btn-icon rounded-0 me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-outline-primary btn-icon rounded-0 me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-outline-secondary btn-icon rounded-0 my-1"><i
                                                data-feather="feather"></i></button>
                                    </div>
                                    <div class="bg-light p-4 small">
                                        Append the
                                        <code>.rounded-0</code>
                                        helper utility class onto any button and it will square the edges, resulting in a
                                        squared button.
                                    </div>
                                </div>
                            </div>
                            <div class="sbp-btn-example mb-4">
                                ...
                                <div class="border border-lg rounded">
                                    <div class="p-4 border-bottom">
                                        ...
                                        <button class="btn btn-primary btn-icon shadow-sm me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-secondary btn-icon shadow-sm me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-outline-primary btn-icon shadow-sm me-2 my-1"><i
                                                data-feather="feather"></i></button>
                                        <button class="btn btn-outline-secondary btn-icon shadow-sm my-1"><i
                                                data-feather="feather"></i></button>
                                    </div>
                                    <div class="bg-light p-4 small">
                                        Append the
                                        <code>.shadow-sm</code>
                                        helper utility class onto any button and it will give the button a subtle shadow
                                        effect. You can use the
                                        <code>.shadow</code>
                                        and
                                        <code>.shadow-lg</code>
                            ...
                            <div class="sbp-btn-example mb-4">
                                ...
                                <div class="border border-lg rounded">
                                    ...
                                    <div class="bg-light p-4 small">
                                        ...
                                        helper utility class onto any button and it will give the button a pill effect.
                                        Note, this will have no effect on icon buttons which are already circular.
                                    </div>
                                </div>
                            </div>
                            <div class="sbp-btn-example">
                                ...
                                <div class="border border-lg rounded">
                                    <div class="p-4 border-bottom">
                                        ...
                                        <button
                                            class="btn btn-outline-primary rounded-pill px-4 me-2 my-1">Primary</button>
                                        <button
                                            class="btn btn-outline-secondary rounded-pill px-4 me-2 my-1">Secondary</button>
                                        <button
                                            class="btn btn-sm btn-primary p-3 line-height-normal me-2 my-1">Primary</button>
                                        <button
                                            class="btn btn-sm btn-secondary p-3 line-height-normal my-1">Secondary</button>
                                    </div>
                                    <div class="bg-light p-4 small">
                                        Spacing utilities are especially useful when trying to achieve a certain look and
                                        feel for a specific button. In the above example, the
                                        <code>.px-4</code>
                                        helper utility was added to the button component in order to create more negative
                                        space to the left and right sides of the button.
                                    </div>
                                    <div class="p-4 border-bottom">
                                        <button
                                            class="btn btn-primary btn-sm rounded-0 shadow-sm px-4 py-3 text-uppercase fw-800 me-2 my-1">Primary</button>
                                        <button
                                            class="btn btn-secondary btn-sm rounded-0 shadow-sm px-4 py-3 text-uppercase fw-800 me-2 my-1">Secondary</button>
                                        <button
                                            class="btn btn-outline-primary btn-sm rounded-0 shadow-sm px-4 py-3 text-uppercase fw-800 me-2 my-1">Primary</button>
                                        <button
                                            class="btn btn-outline-secondary btn-sm rounded-0 shadow-sm px-4 py-3 text-uppercase fw-800 my-1">Secondary</button>
                                    </div>
                                    <div class="bg-light p-4 small">Multiple utility classes used together can drastically
                                        change the styling of a button. This should only be done in cases where only a
                                        single button, or a small group of buttons need to have a specific style. To modify
                                        buttons globally, it is best to override button SCSS variables.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col">
                            <div class="card-body py-5">
                                ...
                                <p class="card-text">Buttons are a default component included with the Bootstrap framework.
                                    For more information on implementing, modifying, and extending the usage of buttons
                                    within your project, visit the official Bootstrap buttons documentation page.</p>
                                <a class="btn btn-secondary btn-sm"
                                    href="https://getbootstrap.com/docs/4.4/components/buttons/" target="_blank">
                            ...
                            <ul class="nav flex-column" id="stickyNav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav flex-column ms-3">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#customColorsOutline">Outline</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="nav flex-column ms-3">
                                        <li class="nav-item"><a class="nav-link" href="#iconFeather">Feather Icons</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="#iconFontAwesome">Font Awesome
                                                Icons</a></li>
