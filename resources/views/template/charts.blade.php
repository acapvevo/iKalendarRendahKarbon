...
@section('title')
    <h1 class="app-page-title">Chart</h1>
@endsection
            ...
            <div class="app-card-body p-4">
                <div class="row gx-5 gy-3">
                    <div class="col-12 col-lg-9">
                        ...
                        <div>You can use <a href="https://www.chartjs.org/" target="_blank">Chart.js</a> to create charts for
                            your app. To configure the charts on this page you can edit the relevant JavaScript file:
                    ...
                    <div class="col-12 col-lg-3">
                        <a class="btn app-btn-primary" href="https://www.chartjs.org/docs/latest/" target="_blank"><svg
                                width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-up-right-square me-2"
