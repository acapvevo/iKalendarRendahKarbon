            ...
            <div class="page-header-content pt-4">
                ...
                <nav class="mt-4 rounded" aria-label="breadcrumb">
                    <ol class="breadcrumb px-3 py-2 rounded mb-0">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('resident.contest.submission.category', ['submission_id' => $submission->id]) }}">{{ __($categoryDescription) }}</a>
                        </li>
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card">
            <div class="card-header text-center">
                {{ __('Submission Details for') }}<br>{{ $submission->community->name ?? $submission->community->username }}<br>({{ __($categoryDescription) }})
            </div>
            <div class="card-body">
                ...
                <div class="tab-content py-3" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-record" role="tabpanel"
                        ...
                        @livewire('resident.contest.record', ['submission' => $submission, 'category' => $category])

                    </div>
                    <div class="tab-pane fade" id="pills-evidence" role="tabpanel" aria-labelledby="pills-evidence-tab"
                        tabindex="0">

                        @livewire('resident.contest.evidence', ['submission' => $submission, 'category' => $category])

                    </div>
                    {{-- <div class="tab-pane fade" id="pills-answer" role="tabpanel" aria-labelledby="pills-answer-tab"
                        tabindex="0">
                        @livewire('resident.contest.answer', ['submission' => $submission, 'category' => $category])
