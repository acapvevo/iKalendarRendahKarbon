    ...
    <div class="col-lg-5">
        ...
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            <div class="card-header justify-content-center">
                <h3 class="fw-light my-4 text-center">Login As Community</h3>
            </div>
            <div class="card-body">
                <!-- Login form-->
                <form class="auth-form login-form" action="{{ route('community.login') }}" method="post">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        <a class="small" href="{{ route('community.password.request') }}">Forgot Password?</a>
                        <button type="submit" class="btn btn-primary">Login</button>
                    </div>
                </form>
            </div>
            <div class="card-footer text-center">
                <div class="small"><a href="{{ route('community.register') }}">Need an account? Sign up!</a>
                </div>
            </div>
        </div>
    </div>
